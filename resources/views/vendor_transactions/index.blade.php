                            ...
                            <table class="table table-hover table-striped text-center mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th style="width: 210px;">العمليات</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td class="font-weight-bold text-primary">
                                                {{ $transaction->vendor->name ?? 'مورد محذوف' }}
                                            </td>
                                            ...
                                            <td class="text-muted text-right px-3">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('transactions.receipt', $transaction->id) }}" target="_blank"
                                                    class="btn btn-sm btn-info ml-1" title="طباعة السند">
                                                    <i class="fas fa-receipt ml-1"></i> سند
                                                </a>
                                                ...
                                                <form action="{{ route('transactions.destroy', $transaction->id) }}"
                                                    ...
                                                    onsubmit="return confirm('هل أنت متأكد من حذف هذه الحركة المالية نهائياً؟');">
                                                    @csrf
                                                    @method('DELETE')
