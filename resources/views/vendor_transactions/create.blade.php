                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-3">
                                <label for="vendor_id" class="col-sm-3 col-form-label font-weight-bold">
                                    المورد المستهدف <span class="text-danger">*</span>
                                </label>
                                <div class="col-sm-9">
                                    <select class="form-control" id="vendor_id" name="vendor_id" required>
                                        ...
                                        @foreach($vendors as $vendor)
                                            <option value="{{ $vendor->id }}">
                                                {{ $vendor->name }} (الرصيد الحالي: {{ number_format($vendor->balance, 2) }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="0.01" min="0.01" class="form-control text-left"
                                        id="amount" name="amount" required dir="ltr">
                                </div>
                            </div>
