...
<div class="container row" >
    <div class="container col-3" >
        <form action="/pulled_from_net_income_report?fromdate={{Request('fromdate')}}&todate={{Request('todate')}}" method="get">
            {{ csrf_field() }}
            <div class="container-fluid row ">
                ...
                <div class="col-12">
                    <label for="category_id" class="form-label"><strong>الحساب</strong></label>
    ...
    <div class="container col-9" id="printableArea">
        ...
        <div class="row" style="border: 2px solid #6574cd;">
            <div class="col-12 text-center">
                ...
                <br>
                <h4>تقرير: مسحوبات من صافي الربح</h4>
                <br>
...
{{--        $('#category_id').select2({--}}
{{--            placeholder: 'اختر مجموعة الحساب',--}}
