...
<div class="container row">
    <div class="container col-4">
        <form action="/gl_exec?fromdate={{Request('fromdate')}}&todate={{Request('todate')}}" method="get">
            {{ csrf_field() }}
            <div class="container-fluid row ">
                <div class="col-12">
                    <label for="fromdate" class="form-label"><strong>From Date</strong></label>
                    <input type="date" value="{{Request('fromdate') ?? \Carbon\Carbon::today()}}" class="form-control" id="fromdate" name="fromdate">
                </div>
                <br><br><br>

                <div class="col-12">
                    <label for="todate" class="form-label"><strong>To Date</strong></label>
                    <input type="date" value="{{Request('fromdate') ?? \Carbon\Carbon::today()}}" class="form-control" id="todate" name="todate">
                </div>
            </div>
            <br>
            <div class="col-12">
