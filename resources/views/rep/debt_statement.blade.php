...
<div class="content-header text-right">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0 text-dark"><i class="fas fa-file-invoice-dollar ml-2 text-primary"></i> كشف المديونية</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline shadow-sm mb-4 no-print">
            <div class="card-header">
                <h3 class="card-title font-weight-bold"><i class="fas fa-sliders-h ml-2 text-primary"></i> خيارات البحث والفلترة</h3>
            </div>
            <div class="card-body">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3 form-group mb-3">
                            ...
                            <select class="form-control" name="company_filter">
                                ...
                                <option value="all" {{ request('company_filter') == 'all' ? 'selected' : '' }}>كل الشركات</option>
                                @foreach($companies as $c)
                                    <option value="{{ $c->id }}" {{ request('company_filter') == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-bordered table-hover table-sm text-center mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="5" class="text-center py-5 text-muted">لا توجد بيانات مطابقة لمعايير البحث.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
